...
function dac_array_fsa {
  ...
  ./project/build/build $1 $2 $3 2 >$3.stdout 2>&1
}
...
function array_ts_fsa_noBro {
  $TIME_CMD -f $TIME_FMT -o $2.log \
  ./project/build/build $1 $2 $3 5 >$3.stdout 2>&1
}

function array_ts_fsa_noCompID {
  $TIME_CMD -f $TIME_FMT -o $2.log \
  ./project/build/build $1 $2 $3 6 >$3.stdout 2>&1
}

function array_ts_fsa_noCompWo {
  $TIME_CMD -f $TIME_FMT -o $2.log \
  ./project/build/build $1 $2 $3 7 >$3.stdout 2>&1
}
